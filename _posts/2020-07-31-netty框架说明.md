...
![image.png]({{ site.url }}/source/nodebook/java_netty_1_1.png)
...
![image.png]({{ site.url }}/source/nodebook/java_netty_1_2.jpg)
...
![image.png]({{ site.url }}/source/nodebook/java_netty_1_3.png)
...
![image.png]({{ site.url }}/source/nodebook/java_netty_1_8.png)

ChannelPipeline 提供了基于继承接口的过滤功能， 允许我们的事件在链表中只在对应的实现中传递。

我们通过一个实际的事件来说明事件传递方式 : 

![image.png]({{ site.url }}/source/nodebook/java_netty_1_5.png)
...
![image.png]({{ site.url }}/source/nodebook/java_netty_1_6.png)
...
![image.png]({{ site.url }}/source/nodebook/java_netty_1_7.png)
...
![image.png]({{ site.url }}/source/nodebook/java_netty_1_9.png)
