...
![image.png]({{ site.url }}/assets/spark_scheduler_2_1.png)
...
![image.png]({{ site.url }}/assets/spark_scheduler_2_2.png)
...
![image.png]({{ site.url }}/assets/spark_scheduler_2_3.png)
...
![image.png]({{ site.url }}/assets/spark_scheduler_2_4.png)
...
![image.png]({{ site.url }}/assets/spark_scheduler_2_5.png)
...
![image.png]({{ site.url }}/assets/spark_scheduler_2_6.png)

##### FairSchedulableBuilder

FAIR模式中有一个rootPool和多个子Pool，各个子Pool中存储着所有待分配的TaskSetMagager。

![image.png]({{ site.url }}/assets/spark_scheduler_2_7.png)
